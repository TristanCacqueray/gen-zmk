...
… into [zmk config](https://github.com/TristanCacqueray/zmk-config/blob/main/config/gen-zmk.dtsi), [qmk_config](https://github.com/TristanCacqueray/qmk-config/blob/main/gen_qmk.h) and such documentation diagrams:
